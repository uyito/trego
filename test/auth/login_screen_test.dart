...
void main() {
  ...
  testWidgets('LoginScreen builds and shows key fields', (tester) async {
    // LoginScreen constructs AuthService(), which touches
    ...
    for (final e in captured) {
      ...
      expect(
        ...
        isTrue,
        reason: 'Unexpected exception during LoginScreen test: $e',
      );
    }
  });
}
