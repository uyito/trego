...
class RecordingSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final prefs = context.watch<RecordPreferences>();
    return TregoScaffold(
      appBar: const TregoAppBar(title: 'Recording'),
      body: ListView(
        children: [
          _Row(
            title: 'Auto-pause',
            subtitle: 'Pauses when you stop moving; resumes when you start again',
            selected: prefs.autoPauseEnabled,
            onTap: () => prefs.setAutoPauseEnabled(!prefs.autoPauseEnabled),
          ),
        ],
      ),
    );
